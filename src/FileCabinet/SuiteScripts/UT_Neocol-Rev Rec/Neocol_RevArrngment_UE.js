...
define(['N/search', 'N/record', 'N/runtime', 'N/format'],
    ...
    function (search, record, runtime, format) {
        ...
        function beforeSubmit(context) {
            ...
            log.debug('revenueElementLineCount', revenueElementLineCount)
            var orderId = '';
            ...
            for (var i=0; revenueElementLineCount != 0 && i < revenueElementLineCount; i++){
                ...
                var sourceIdLookupObj = search.lookupFields({
                    type: 'customrecord_contractlines',
                    id: sourceId,
                    columns: ['custrecord_neo_cl_specialterms', 'custrecord_neo_cl_termsforconv', 'custrecord_neo_cl_specialtermsnotes', 'custrecord_bypass_fvcalc', 'custrecord_is_cl_order', 'custrecord_neo_cl_totalotd']
                });


              if (typeof(sourceIdLookupObj.custrecord_is_cl_order) != 'undefined')
              {
                var orderIdObj = sourceIdLookupObj.custrecord_is_cl_order[0];
                orderId = orderIdObj.value;
              }

                var contractLineSpecialTerms = sourceIdLookupObj.custrecord_neo_cl_specialterms
                if(contractLineSpecialTerms == true){
                    checkSpecialTerms = true
                }

                var contractLineTermsforConvenience = sourceIdLookupObj.custrecord_neo_cl_termsforconv
                if(contractLineTermsforConvenience == true){
                    checkTermsforConvenience = true
                }

                var contractLineSpecialTermsNotes = sourceIdLookupObj.custrecord_neo_cl_specialtermsnotes
                var addToSpecialTermsNotes = revArgSpecialTermsNotes.indexOf(contractLineSpecialTermsNotes)
                if(addToSpecialTermsNotes < 0){
                    revArgSpecialTermsNotes += ' - ' + contractLineSpecialTermsNotes
                }
                ...
                var ItemLookupObj = search.lookupFields({
                    ...
                    id: itemId,
                    columns: ['itemrevenuecategory', 'custitem_premier_support', 'custitem_ia_platform','custitem_ia_seats', 'custitem_mypanel', 'custitem_subscription',  'custitem_platform', 'custitem_seats', 'custitem_otd_item']
                });
                //log.debug('ItemLookupObj', ItemLookupObj)

                //var itemRevenueCategory = ItemLookupObj.itemrevenuecategory[0].value
                //log.debug('itemRevenueCategory', itemRevenueCategory)

                var subscriptionItem = ItemLookupObj.custitem_subscription
                var platformItem = ItemLookupObj.custitem_platform
                var seatsItem = ItemLookupObj.custitem_seats

                var discountItem = ItemLookupObj.custitem_discount_item
                var totalOneTimeDiscount = sourceIdLookupObj.custrecord_neo_cl_totalotd
                ...
                if(discountItem == true || (!isEmpty(totalOneTimeDiscount) && totalOneTimeDiscount != 0.00 )){
                ...
                var premierSupportItem = ItemLookupObj.custitem_premier_support
                var iaPlatformItem = ItemLookupObj.custitem_ia_platform
                var iaSeatsItem = ItemLookupObj.custitem_ia_seats
                var myPanelItem = ItemLookupObj.custitem_mypanel

                if(premierSupportItem === true) {
          ...
          for (var j = 0; revenueElementLineCount != 0 && j < revenueElementLineCount; j++){
                ...
                var setItemLookupObj = search.lookupFields({
                    type: search.Type.ITEM,
                    id: subscriptionItemId,
                    columns: ['itemrevenuecategory', 'custitem_premier_support', 'custitem_ia_platform','custitem_ia_seats', 'custitem_mypanel']
                });

                var sourceIdLookup = newRecord.getSublistValue({sublistId: 'revenueelement', fieldId: 'sourceid', line: j});
                log.debug('sourceIdLookup', sourceIdLookup)

                var setSourceIdLookupObj = search.lookupFields({
                    type: 'customrecord_contractlines',
                    id: sourceIdLookup,
                    columns: ['custrecord_neo_cl_specialterms', 'custrecord_neo_cl_termsforconv', 'custrecord_neo_cl_specialtermsnotes', 'custrecord_bypass_fvcalc']
                });

                var bypassFvCalc = setSourceIdLookupObj.custrecord_bypass_fvcalc
                if (bypassFvCalc === true){
                ...
                var premierSupportItem = setItemLookupObj.custitem_premier_support
                var iaPlatformItem = setItemLookupObj.custitem_ia_platform
                var iaSeatsItem = setItemLookupObj.custitem_ia_seats
                var myPanelItem = setItemLookupObj.custitem_mypanel

                if(premierSupportItem === true && bypassFvCalc === false && manualFairValueOverride === false) {
                ...
                if(iaPlatformItem === true  && bypassFvCalc === false && manualFairValueOverride === false) {
                ...
                if(iaSeatsItem === true && bypassFvCalc === false && manualFairValueOverride === false) {
                ...
                if(myPanelItem === true  && bypassFvCalc === false && manualFairValueOverride === false) {
